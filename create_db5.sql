...
*****************************************/
DROP DATABASE IF EXISTS cb256_my_guitar_shop1;
CREATE DATABASE cb256_my_guitar_shop1;
USE cb256_my_guitar_shop1;  -- MySQL command
...
*****************************************/
DROP DATABASE IF EXISTS cb256_my_guitar_shop2;
CREATE DATABASE cb256_my_guitar_shop2;
USE cb256_my_guitar_shop2;
...
CREATE TABLE music(
  ...
  groupNm           VARCHAR(255)   NOT NULL,
  pieceNm           VARCHAR(255)   NOT NULL,
  linkTxt           VARCHAR(255)   NOT NULL,
...
CREATE TABLE cart(
  ...
  metaFlg           TINYINT(1)     NOT NULL    DEFAULT 0,
  categoryID        INT            NOT NULL,
  categoryName      VARCHAR(255)   NOT NULL,
  productID         INT            NOT NULL,
  productName       VARCHAR(255)   NOT NULL,
  pricePd           DECIMAL(10,2)  NOT NULL,
  PRIMARY KEY (cartID)
);
...
(11, 4, 'yamkb', 'Yamaha 88 Key Digital Keyboard', 'Product Features:\r\n\r\n* Graded hammer technology', '474.99', '10.00', '2010-08-15 13:20:01'),
(12, 4, 'yamsyn', 'Yamaha 49 Key Synthesizer Keyboard', 'The Yamaha MX49 49 Key Synthesizer Keyboard is an expressive instrument with over 1000 Motif XS sounds, USB Audio/MIDI connectivity and advanced DAW/VST controller features! With the MX49 you get realistic piano, EP, strings and drums along with out of this world 8-element synth sounds in one easy to use, affordable keyboard. VCM effects as well as analog and digital connectivity allow this Yamaha synth to be used in virtually any set-up.', '649.99', '10.00', '2010-08-15 13:20:02'),
(13, 4, 'ackb', 'Yamaha Upright Piano', 'Refurbished by Four Star Piano', 
'3100.00', '0.00', '2010-08-15 13:20:03');
...
INSERT INTO cart (cartID, metaFlg, categoryID, categoryName, productID, productName, pricePd) VALUES
(1, 0, 1, 'Guitars', 1, 'Fender Stratocaster', '489,30');
